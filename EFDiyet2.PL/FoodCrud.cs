...
namespace EFDiyet2.PL
{
    public partial class FoodCrud : Form
    {
        ...
        private void dtwFOOD_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (rowIndex >= 0 && rowIndex < dtwFOOD.Rows.Count)
                {
                    ...
                    cmbFOODCATEGORY.SelectedValue = _selectedFood.FoodCategory.Id;
        ...
        private void btnADD_Click_1(object sender, EventArgs e)
        {
            ...
            {
                float calorie;
                if (float.TryParse(txtCALORIE.Text, out calorie) && pctCHOOSENFOOD.Image!=null)
                {
                ...
                {
                    ShowErrorMessage("Invalid calorie value or image. Please enter a valid number.");
                }
            }
            catch (Exception ex)
            {
