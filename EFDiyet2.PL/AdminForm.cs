...
namespace EFDiyet2.PL
{
    public partial class AdminForm : Form
    {
        ...
        {
            Form[] FormNames = { adminReport, foodCategoryCrud, mealCrud, foodCrud, adminUserCrud };
        ...
        {
            adminUserCrud = new AdminUserCrud();
            adminUserCrud.MdiParent = this;
            adminUserCrud.Dock = DockStyle.Fill;
            this.Size = adminUserCrud.Size;
            this.Location = new Point((Screen.PrimaryScreen.Bounds.Width - this.Width) / 2,
                          (Screen.PrimaryScreen.Bounds.Height - this.Height) / 2);
            HideForms(adminUserCrud.Name);
            adminUserCrud.Show();
        }
    }
}
